...
- 消息写明完整年份时使用该年份；只写月日时自动选择今天或下一次尚未过去的日期，可自然跨年。
...
- `2027年1月5日` 或 `2027-01-05`：保留消息中明确写出的年份。
- `1月5日`：以解析当天为基准；若今年的1月5日尚未到达则使用今年，否则使用下一年。
- `今晚`、`明天`、`后天`：以点击“解析消息”的当天为基准，年底时会自动跨年。
- 所有解析结果都可在确认导入前手工修改。
